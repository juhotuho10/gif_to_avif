...
avifenc --yuv 422 --nclx 1/13/1 -q 20 --qalpha 90 -j 8 --codec aom --speed 2 -a enable-chroma-deltaq=1 -a enable-qm=0 -a color:aq-mode=1 --timescale 1000 --tilerowslog2 1 --tilecolslog2 1 --duration !duration! -o "%basename%.avif" %files%
